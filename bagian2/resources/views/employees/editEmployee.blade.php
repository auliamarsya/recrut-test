                ...
                <div class="card-body p-4">
                    <form action="{{ route('update.employee') }}" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="employee_name" class="form-control @error('employee_name') is-invalid @enderror" id="employee_name" placeholder="Employee Name" value="{{ $employee['name'] }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Email" value="{{ $employee['email'] }}" required>
